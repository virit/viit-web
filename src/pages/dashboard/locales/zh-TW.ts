export default {
  ...
  'dashboard.analysis.day-sales': '日銷售額',
  ...
  'dashboard.channel.online': '線上',
  'dashboard.channel.stores': '門店',
  'dashboard.analysis.sales': '銷售額',
  'dashboard.analysis.traffic': '客流量',
  'dashboard.table.rank': '排名',
  'dashboard.table.search-keyword': '搜索關鍵詞',
  'dashboard.table.users': '用戶數',
  'dashboard.table.weekly-range': '周漲幅',
};
